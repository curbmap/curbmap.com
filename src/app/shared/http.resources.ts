...
export function sendPost(http: Http, type: Object, body: string, address: string, extractData: Function, handleError: Function): Observable<string> {
...
export function sendGet(http: Http, type: Object, address: string, extractData: Function, handleError: Function): Observable<string> {
  let reqHeaders = new Headers(type);
  let reqOptions = new RequestOptions({headers: reqHeaders});
